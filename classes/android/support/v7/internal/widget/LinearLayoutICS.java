  ...
  extends LinearLayout
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (localView == null) {}
    for (int i = getWidth() - getPaddingRight() - this.b;; i = localView.getRight())
    {
      b(paramCanvas, i);
      return;
    }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\android\support\v7\internal\widget\LinearLayoutICS.class
