...
public class UploadPicListener
  extends BaseRequestListener
{
  ...
  public void onComplete(String paramString, Object paramObject)
  {
    ...
    if (j == 0)
    {
      paramObject = new Pic(localJSONObject.getString("albumid"), localJSONObject.getString("lloc"), localJSONObject.getString("sloc"), localJSONObject.getInt("width"), localJSONObject.getInt("height"));
      this.mCallback.onSuccess(paramObject);
      TDebug.i("UploadPicListener", paramString);
      return;
    }
  }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\tencent\tauth\http\RequestListenerImpl\UploadPicListener.class
