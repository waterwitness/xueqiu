  ...
  extends BaseRequestListener
{
  ...
  public void onComplete(String paramString, Object paramObject)
  {
    ...
    if (j == 0)
    {
      paramObject = new UserInfo(localJSONObject.getString("nickname"), localJSONObject.getString("figureurl"), localJSONObject.getString("figureurl_1"), localJSONObject.getString("figureurl_2"));
      this.mCallback.onSuccess(paramObject);
      TDebug.i("UserInfoListener", paramString);
      return;
    }
  }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\tencent\tauth\http\RequestListenerImpl\UserInfoListener.class
