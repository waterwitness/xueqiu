  ...
  extends BaseRequestListener
{
  ...
  public void onComplete(String paramString, Object paramObject)
  {
    ...
    if (j == 0)
    {
      paramObject = new Album(localJSONObject.getString("albumid"), localJSONObject.getInt("classid"), localJSONObject.getLong("createtime"), localJSONObject.getString("desc"), localJSONObject.getString("name"), 0L, localJSONObject.getInt("priv"));
      this.mCallback.onSuccess(paramObject);
      TDebug.i("AddAlbumListener", paramString);
      return;
    }
  }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\tencent\tauth\http\RequestListenerImpl\AddAlbumListener.class
