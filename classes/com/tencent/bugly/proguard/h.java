...
public final class h
{
  ...
  private static int a(h.a parama, ByteBuffer paramByteBuffer)
  {
  ...
  private <T> T[] b(T paramT, int paramInt, boolean paramBoolean)
  {
    ...
    {
      localObject = new h.a();
      a((h.a)localObject, this.a);
      switch (((h.a)localObject).a)
      {
      default: 
        throw new g("type mismatch.");
      }
  ...
  public final String b(int paramInt, boolean paramBoolean)
  {
    ...
    if (a(paramInt))
    {
      ...
      a((h.a)localObject1, this.a);
      switch (((h.a)localObject1).a)
      {
      default: 
        throw new g("type mismatch.");
      case 6: 
  ...
  public final byte[] c(int paramInt, boolean paramBoolean)
  {
    ...
    if (a(paramInt))
    {
      ...
      case 13: 
        ...
        a((h.a)localObject2, this.a);
        if (((h.a)localObject2).a != 0) {
          throw new g("type mismatch, tag: " + paramInt + ", type: " + ((h.a)localObject1).a + ", " + ((h.a)localObject2).a);
        }
        i = a(0, 0, true);
        if (i < 0) {
          throw new g("invalid size, tag: " + paramInt + ", type: " + ((h.a)localObject1).a + ", " + ((h.a)localObject2).a + ", size: " + i);
        }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\tencent\bugly\proguard\h.class
