...
final class a
{
  ...
  public static boolean a(Signature[] paramArrayOfSignature, boolean paramBoolean)
  {
    ...
    while (i < j)
    {
      String str = paramArrayOfSignature[i].toCharsString().toLowerCase();
      com.tencent.mm.sdk.b.a.c("MicroMsg.SDK.WXMsgImplComm", "check signature:" + str);
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\tencent\mm\sdk\openapi\a.class
