...
public class MobclickAgent
{
  ...
  public static void onEvent(Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      es.a("MobclickAgent", "label is null or empty");
      return;
    }
  ...
  public static void onEvent(Context paramContext, String paramString, Map<String, String> paramMap)
  {
    if (paramMap == null)
    {
      es.b("MobclickAgent", "input map is null");
      return;
    }
  ...
  public static void onEventDuration(Context paramContext, String paramString, long paramLong)
  {
    if (paramLong <= 0L)
    {
      es.a("MobclickAgent", "duration is not valid in onEventDuration");
      return;
    }
  ...
  public static void onPageEnd(String paramString)
  {
    ...
    es.b("MobclickAgent", "pageName is null or empty");
  }
  ...
  public static void onResume(Context paramContext, String paramString1, String paramString2)
  {
    ...
    {
      es.b("MobclickAgent", "unexpected empty appkey in onResume");
      return;
    }
  ...
  public static void setUserID(Context paramContext, String paramString1, String paramString2, Gender paramGender, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      return;
      es.c("MobclickAgent", "userID is null or empty");
      paramString1 = null;
      break;
      label55:
      es.a("MobclickAgent", "id source is null or empty");
      paramString2 = null;
      break label14;
      label67:
      es.a("MobclickAgent", "not a valid age!");
      paramInt = -1;
    }
  }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\umeng\analytics\MobclickAgent.class
