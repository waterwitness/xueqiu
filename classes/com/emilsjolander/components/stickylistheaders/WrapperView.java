  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.mHeader != null)
    {
      ...
      if ((localLayoutParams != null) && (localLayoutParams.height > 0))
      {
        ...
        paramInt1 = this.mHeader.getMeasuredHeight() + 0;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        paramInt1 = this.mDividerHeight + 0;
        break label67;
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\emilsjolander\components\stickylistheaders\WrapperView.class
