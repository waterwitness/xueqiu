...
public class ab
  implements Serializable, Cloneable, org.apache.a.b<ab, ac>
{
  public static final Map<ac, org.apache.a.a.b> h;
  private static final m i = new m("XmPushActionSubscription");
  ...
  static
  {
    EnumMap localEnumMap = new EnumMap(ac.class);
    localEnumMap.put(ac.a, new org.apache.a.a.b("debug", (byte)2, new c((byte)11)));
    localEnumMap.put(ac.b, new org.apache.a.a.b("target", (byte)2, new g(f.class)));
    localEnumMap.put(ac.c, new org.apache.a.a.b("id", (byte)1, new c((byte)11)));
    localEnumMap.put(ac.d, new org.apache.a.a.b("appId", (byte)1, new c((byte)11)));
    localEnumMap.put(ac.e, new org.apache.a.a.b("topic", (byte)1, new c((byte)11)));
    localEnumMap.put(ac.f, new org.apache.a.a.b("packageName", (byte)2, new c((byte)11)));
    localEnumMap.put(ac.g, new org.apache.a.a.b("category", (byte)2, new c((byte)11)));
    h = Collections.unmodifiableMap(localEnumMap);
    org.apache.a.a.b.a(ab.class, h);
  }
  ...
  public final boolean a(ab paramab)
  {
    ...
    do
    {
            ...
            do
            {
              do
              {
                do
                {
                  ...
                  bool1 = a();
                  bool2 = paramab.a();
                } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.a.equals(paramab.a))));
                bool1 = b();
                bool2 = paramab.b();
              } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.b.a(paramab.b))));
              bool1 = c();
              bool2 = paramab.c();
            } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.c.equals(paramab.c))));
            bool1 = d();
            bool2 = paramab.d();
      ...
      bool1 = g();
      bool2 = paramab.g();
    } while (((bool1) || (bool2)) && ((!bool1) || (!bool2) || (!this.g.equals(paramab.g))));
    return true;
  }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\xiaomi\g\a\ab.class
