...
public class OldPortFolio$SortByCurrentPriceDown
  implements Serializable, Comparator<OldPortFolio>
{
  public int compare(OldPortFolio paramOldPortFolio1, OldPortFolio paramOldPortFolio2)
  {
    ...
    if (paramOldPortFolio2.getCurrent() - paramOldPortFolio1.getCurrent() > 0.0D) {
      return 1;
    }
    return -1;
  }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\xueqiu\android\stock\model\OldPortFolio$SortByCurrentPriceDown.class
