...
public class OldPortFolio$SortByMarketCapitalDown
  implements Serializable, Comparator<OldPortFolio>
{
  public int compare(OldPortFolio paramOldPortFolio1, OldPortFolio paramOldPortFolio2)
  {
    ...
    if (paramOldPortFolio2.getMarketCapital() - paramOldPortFolio1.getMarketCapital() > 0.0D) {
      return 1;
    }
    return -1;
  }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\xueqiu\android\stock\model\OldPortFolio$SortByMarketCapitalDown.class
