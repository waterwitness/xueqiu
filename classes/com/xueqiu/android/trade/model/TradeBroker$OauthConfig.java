...
public class TradeBroker$OauthConfig
  implements Parcelable
{
  public static final Parcelable.Creator<OauthConfig> CREATOR = new Parcelable.Creator()
  {
    public final TradeBroker.OauthConfig createFromParcel(Parcel paramAnonymousParcel)
    {
      return new TradeBroker.OauthConfig(paramAnonymousParcel, null);
    }
    
    public final TradeBroker.OauthConfig[] newArray(int paramAnonymousInt)
    {
      return new TradeBroker.OauthConfig[paramAnonymousInt];
    }
  };
  @Expose
  ...
  private TradeBroker$OauthConfig(Parcel paramParcel)
  {
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\xueqiu\android\trade\model\TradeBroker$OauthConfig.class
