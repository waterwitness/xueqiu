...
final class Hpack
{
  private static final Map<g, Integer> NAME_TO_FIRST_INDEX = nameToFirstIndex();
  ...
  private static g checkLowercase(g paramg)
  {
    int i = 0;
    int j = paramg.c.length;
    while (i < j)
    {
      int k = paramg.c[i];
      if ((k >= 65) && (k <= 90)) {
        throw new IOException("PROTOCOL_ERROR response malformed: mixed case name: " + paramg.a());
      }
      i += 1;
    }
    return paramg;
  ...
  private static Map<g, Integer> nameToFirstIndex()
  {
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\squareup\okhttp\internal\spdy\Hpack.class
