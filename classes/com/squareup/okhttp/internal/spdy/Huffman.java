...
class Huffman
{
  ...
  private void addCode(int paramInt1, int paramInt2, byte paramByte)
  {
    ...
    for (Huffman.Node localNode1 = this.root; paramByte > 8; localNode1 = Huffman.Node.access$000(localNode1)[paramInt1])
    {
      paramByte = (byte)(paramByte - 8);
      paramInt1 = paramInt2 >>> paramByte & 0xFF;
      if (Huffman.Node.access$000(localNode1) == null) {
        throw new IllegalStateException("invalid dictionary: prefix not unique");
      }
      if (Huffman.Node.access$000(localNode1)[paramInt1] == null) {
        Huffman.Node.access$000(localNode1)[paramInt1] = new Huffman.Node();
      }
    }
    ...
    {
      Huffman.Node.access$000(localNode1)[paramInt1] = localNode2;
      paramInt1 += 1;
    }
  }
  ...
  byte[] decode(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      while (i >= 8)
      {
        localNode1 = Huffman.Node.access$000(localNode1)[(k >>> i - 8 & 0xFF)];
        if (Huffman.Node.access$000(localNode1) == null)
        {
          localByteArrayOutputStream.write(Huffman.Node.access$100(localNode1));
          i -= Huffman.Node.access$200(localNode1);
    ...
    while (m > 0)
    {
      paramArrayOfByte = Huffman.Node.access$000(localNode2)[(k << 8 - m & 0xFF)];
      if ((Huffman.Node.access$000(paramArrayOfByte) != null) || (Huffman.Node.access$200(paramArrayOfByte) > m)) {
        break;
      }
      localByteArrayOutputStream.write(Huffman.Node.access$100(paramArrayOfByte));
      m -= Huffman.Node.access$200(paramArrayOfByte);
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\squareup\okhttp\internal\spdy\Huffman.class
