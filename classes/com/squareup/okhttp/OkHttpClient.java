  ...
  implements Cloneable
{
  ...
  static
  {
    ...
    Internal.instance = new Internal()
    {
      ...
      public final Connection callEngineGetConnection(Call paramAnonymousCall)
      {
        return paramAnonymousCall.engine.getConnection();
      }
      
      public final void callEngineReleaseConnection(Call paramAnonymousCall)
      {
        paramAnonymousCall.engine.releaseConnection();
      }
      
      public final void callEnqueue(Call paramAnonymousCall, Callback paramAnonymousCallback, boolean paramAnonymousBoolean)
      {
      ...
      public final void closeIfOwnedBy(Connection paramAnonymousConnection, Object paramAnonymousObject)
      {
      ...
      public final void connectionSetOwner(Connection paramAnonymousConnection, Object paramAnonymousObject)
      {
      ...
      public final void setCache(OkHttpClient paramAnonymousOkHttpClient, InternalCache paramAnonymousInternalCache)
      {
        paramAnonymousOkHttpClient.setInternalCache(paramAnonymousInternalCache);
      }
      
      public final void setNetwork(OkHttpClient paramAnonymousOkHttpClient, Network paramAnonymousNetwork)
      {
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\com\squareup\okhttp\OkHttpClient.class
