...
public class Sha2Crypt
{
  ...
  private static String sha2Crypt(byte[] paramArrayOfByte, String paramString1, String paramString2, int paramInt, String paramString3)
  {
    ...
    {
      j = Math.max(1000, Math.min(999999999, Integer.parseInt(((Matcher)localObject1).group(3))));
      i = 1;
    }
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\org\apache\commons\codec\digest\Sha2Crypt.class
