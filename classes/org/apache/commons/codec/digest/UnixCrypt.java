...
public class UnixCrypt
{
  ...
  private static int[] body(int[] paramArrayOfInt, int paramInt1, int paramInt2)
  {
    ...
    permOp(i << 31 | i >>> 1, j << 31 | j >>> 1, 1, 1431655765, paramArrayOfInt);
  ...
  public static String crypt(byte[] paramArrayOfByte, String paramString)
  {
    ...
    int i = 0;
    while ((i < 8) && (i < paramArrayOfByte.length))
    {
  ...
  {
    int i = paramInt2 >>> 16 ^ paramInt2;
    paramInt4 = i & paramInt4;
    paramInt5 = i & paramInt5;
    paramInt4 = paramInt4 ^ paramInt4 << 16 ^ paramInt2 ^ paramArrayOfInt[paramInt3];
    paramInt2 = paramInt5 ^ paramInt5 << 16 ^ paramInt2 ^ paramArrayOfInt[(paramInt3 + 1)];
    paramInt2 = paramInt2 << 28 | paramInt2 >>> 4;
    paramInt3 = SPTRANS[1][(paramInt2 & 0x3F)];
    paramInt5 = SPTRANS[3][(paramInt2 >>> 8 & 0x3F)];
    i = SPTRANS[5][(paramInt2 >>> 16 & 0x3F)];
    return (SPTRANS[7][(paramInt2 >>> 24 & 0x3F)] | paramInt3 | paramInt5 | i | SPTRANS[0][(paramInt4 & 0x3F)] | SPTRANS[2][(paramInt4 >>> 8 & 0x3F)] | SPTRANS[4][(paramInt4 >>> 16 & 0x3F)] | SPTRANS[6][(paramInt4 >>> 24 & 0x3F)]) ^ paramInt1;
  }
  ...
  private static int[] desSetKey(byte[] paramArrayOfByte)
  {
    ...
    int k = (0xF0000000 & i) >>> 4 | (j & 0xFF0000) >>> 16 | (j & 0xFF) << 16 | 0xFF00 & j;
    int m = i & 0xFFFFFFF;
    i = 0;
    j = 0;
    if (i < 16)
    {
      ...
      for (k = k << 26 | k >>> 2;; k = k << 27 | k >>> 1)
      {
        ...
        j = i1 >>> 16 | i2 & 0xFFFF0000;
        arrayOfInt[n] = (j >>> 28 | j << 4);
        i += 1;
        j = n + 1;
        break;
        m = m << 27 | m >>> 1;
  ...
  private static int fourBytesToInt(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    int j = i + 1;
    return byteToUnsigned(paramArrayOfByte[i]) << 8 | paramInt | byteToUnsigned(paramArrayOfByte[j]) << 16 | byteToUnsigned(paramArrayOfByte[(j + 1)]) << 24;
  }
  
  private static int hPermOp(int paramInt1, int paramInt2, int paramInt3)
  {
    paramInt3 = (paramInt1 << 16 - paramInt2 ^ paramInt1) & paramInt3;
    return paramInt3 >>> 16 - paramInt2 ^ paramInt1 ^ paramInt3;
  }
  ...
  private static void permOp(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt)
  {
    ...
    paramArrayOfInt[0] = (paramInt4 << paramInt3 ^ paramInt1);
    paramArrayOfInt[1] = (paramInt4 ^ paramInt2);
  }
}


/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\org\apache\commons\codec\digest\UnixCrypt.class
