  ...
  implements StringEncoder
{
  ...
  public String nysiis(String paramString)
  {
    ...
    do
    {
      ...
      {
        return paramString;
        localObject = SoundexUtils.clean(paramString);
        paramString = (String)localObject;
      } while (((String)localObject).length() == 0);
      paramString = PAT_MAC.matcher((CharSequence)localObject).replaceFirst("MCC");
...
/* Location:              E:\apk\xueqiu2\classes-dex2jar.jar!\org\apache\commons\codec\language\Nysiis.class
