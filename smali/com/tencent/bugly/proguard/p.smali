...
.method public final declared-synchronized onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 69
    const-string v1, " CREATE TABLE IF NOT EXISTS t_ui ( _id INTEGER PRIMARY KEY , _tm int , _ut int , _tp int , _dt blob , _pc text ) "
    ...
    .line 80
    const-string v1, " CREATE TABLE IF NOT EXISTS t_lr ( _id INTEGER PRIMARY KEY , _tp int , _tm int , _pc text , _th text , _dt blob ) "
    ...
    .line 91
    const-string v1, " CREATE TABLE IF NOT EXISTS t_pf ( _id integer , _tp text , _tm int , _dt blob,primary key(_id,_tp )) "
    ...
    .line 101
    const-string v1, " CREATE TABLE IF NOT EXISTS t_crd ( _id integer , _pc text , _tm int , _fl int , _sv text , _av text , _uid integer,primary key(_id,_pc,_uid )) "
    ...
    .line 115
    const-string v1, " CREATE TABLE IF NOT EXISTS t_cr ( _id INTEGER PRIMARY KEY , _tm int , _s1 text , _up int , _me int , _uc int , _dt blob ) "
    ...
    .line 127
    const-string v1, " CREATE TABLE IF NOT EXISTS dl_1002 (_id integer primary key autoincrement, _dUrl varchar(100), _sFile varchar(100), _sLen INTEGER, _tLen INTEGER, _MD5 varchar(100), _DLTIME INTEGER)"
    ...
    .line 140
    const-string v1, "CREATE TABLE IF NOT EXISTS ge_1002 (_id integer primary key autoincrement, _time INTEGER, _datas blob)"
    ...
    .line 149
    const-string v1, " CREATE TABLE IF NOT EXISTS st_1002 ( _id integer , _tp text , _tm int , _dt blob,primary key(_id,_tp )) "
