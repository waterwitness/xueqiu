...
.field private static final NULL_SINK:Lc/r;
...
.field private journalWriter:Lc/e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/squareup/okhttp/internal/DiskLruCache;->NULL_SINK:Lc/r;
...
.method static synthetic access$2500()Lc/r;
    .locals 1

    .prologue
    .line 88
    sget-object v0, Lcom/squareup/okhttp/internal/DiskLruCache;->NULL_SINK:Lc/r;
...
.method private declared-synchronized completeEdit(Lcom/squareup/okhttp/internal/DiskLruCache$Editor;Z)V
    ...
    .line 555
    iget-object v0, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lc/e;
    ...
    invoke-virtual {v2, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$Entry;->writeLengths(Lc/e;)V
...
.method private declared-synchronized edit(Ljava/lang/String;J)Lcom/squareup/okhttp/internal/DiskLruCache$Editor;
    ...
    .line 465
    :cond_2
    iget-object v2, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lc/e;
    ...
    invoke-interface {v2, v3}, Lc/e;->g(I)Lc/e;

    move-result-object v2

    invoke-interface {v2, p1}, Lc/e;->b(Ljava/lang/String;)Lc/e;
    ...
    invoke-interface {v2}, Lc/e;->flush()V
...
.method private newJournalWriter()Lc/e;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lc/r;
    ...
    invoke-direct {v1, p0, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$2;-><init>(Lcom/squareup/okhttp/internal/DiskLruCache;Lc/r;)V
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->source(Ljava/io/File;)Lc/s;
    ...
    .line 265
    :try_start_0
    invoke-interface {v1}, Lc/f;->n()Ljava/lang/String;
    ...
    :cond_2
    :try_start_3
    invoke-direct {p0}, Lcom/squareup/okhttp/internal/DiskLruCache;->newJournalWriter()Lc/e;

    move-result-object v0

    iput-object v0, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lc/e;
    :try_end_3
...
.method private declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->sink(Ljava/io/File;)Lc/r;
    ...
    invoke-interface {v1, v0}, Lc/e;->b(Ljava/lang/String;)Lc/e;

    move-result-object v0

    const/16 v2, 0xa

    invoke-interface {v0, v2}, Lc/e;->g(I)Lc/e;
    ...
    invoke-interface {v1, v2, v3}, Lc/e;->j(J)Lc/e;
    ...
    invoke-interface {v1, v0}, Lc/e;->g(I)Lc/e;
    ...
    invoke-interface {v1, v3}, Lc/e;->b(Ljava/lang/String;)Lc/e;

    move-result-object v3

    const/16 v4, 0x20

    invoke-interface {v3, v4}, Lc/e;->g(I)Lc/e;
    ...
    .line 399
    invoke-virtual {v0, v1}, Lcom/squareup/okhttp/internal/DiskLruCache$Entry;->writeLengths(Lc/e;)V
...
.method public final declared-synchronized get(Ljava/lang/String;)Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;
    ...
    .line 434
    iget-object v1, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lc/e;

    const-string v2, "READ"

    invoke-interface {v1, v2}, Lc/e;->b(Ljava/lang/String;)Lc/e;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, Lc/e;->g(I)Lc/e;

    move-result-object v1

    invoke-interface {v1, p1}, Lc/e;->b(Ljava/lang/String;)Lc/e;
