...
.method private constructor <init>(Lcom/squareup/okhttp/internal/spdy/SpdyConnection$Builder;)V
    ...
    invoke-static {v1}, Lc/m;->a(Ljava/net/Socket;)Lc/r;
    ...
    invoke-interface {v0, v1, v2}, Lcom/squareup/okhttp/internal/spdy/Variant;->newWriter(Lc/e;Z)Lcom/squareup/okhttp/internal/spdy/FrameWriter;
...
.method static synthetic access$1200(Lcom/squareup/okhttp/internal/spdy/SpdyConnection;ILc/f;IZ)V
    .locals 0

    .prologue
    .line 52
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/squareup/okhttp/internal/spdy/SpdyConnection;->pushDataLater(ILc/f;IZ)V
...
.method private pushDataLater(ILc/f;IZ)V
    .locals 9
    ...
    invoke-interface {p2, v0, v1}, Lc/f;->a(J)V

    .line 843
    int-to-long v0, p3

    invoke-interface {p2, v5, v0, v1}, Lc/f;->read(Lc/d;J)J

    .line 1059
    iget-wide v0, v5, Lc/d;->b:J
    ...
    invoke-direct/range {v0 .. v7}, Lcom/squareup/okhttp/internal/spdy/SpdyConnection$6;-><init>(Lcom/squareup/okhttp/internal/spdy/SpdyConnection;Ljava/lang/String;[Ljava/lang/Object;ILc/d;IZ)V
...
.method public final writeData(IZLc/d;J)V
    .locals 10
    ...
    invoke-interface {v0, p2, p1, p3, v1}, Lcom/squareup/okhttp/internal/spdy/FrameWriter;->data(ZILc/d;I)V
    ...
    :goto_0
    invoke-interface {v3, v0, p1, p3, v2}, Lcom/squareup/okhttp/internal/spdy/FrameWriter;->data(ZILc/d;I)V
