...
# direct methods
.method constructor <init>(Lc/f;IZ)V
    .locals 2
    ...
    .line 96
    iput-object p1, p0, Lcom/squareup/okhttp/internal/spdy/Http2$Reader;->source:Lc/f;
    ...
    iget-object v1, p0, Lcom/squareup/okhttp/internal/spdy/Http2$Reader;->source:Lc/f;

    invoke-direct {v0, v1}, Lcom/squareup/okhttp/internal/spdy/Http2$ContinuationSource;-><init>(Lc/f;)V
    ...
    invoke-direct {v0, p2, v1}, Lcom/squareup/okhttp/internal/spdy/Hpack$Reader;-><init>(ILc/s;)V
...
.method private readData(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;IBI)V
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/internal/spdy/Http2$Reader;->source:Lc/f;

    invoke-interface {v0}, Lc/f;->f()B
    ...
    .line 228
    iget-object v3, p0, Lcom/squareup/okhttp/internal/spdy/Http2$Reader;->source:Lc/f;

    invoke-interface {p1, v2, p4, v3, v1}, Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;->data(ZILc/f;I)V
    ...
    invoke-interface {v1, v2, v3}, Lc/f;->f(J)V
...
.method private readGoAway(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;IBI)V
    ...
    invoke-interface {v0, v4, v5}, Lc/f;->c(J)Lc/g;

    move-result-object v0

    .line 347
    :cond_3
    invoke-interface {p1, v1, v3, v0}, Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;->goAway(ILcom/squareup/okhttp/internal/spdy/ErrorCode;Lc/g;)V
...
.method private readPing(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;IBI)V
    ...
    .line 326
    :cond_1
    iget-object v2, p0, Lcom/squareup/okhttp/internal/spdy/Http2$Reader;->source:Lc/f;

    invoke-interface {v2}, Lc/f;->h()I
...
.method private readSettings(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;IBI)V
    ...
    .line 272
    iget-object v4, p0, Lcom/squareup/okhttp/internal/spdy/Http2$Reader;->source:Lc/f;

    invoke-interface {v4}, Lc/f;->h()I
...
.method public final nextFrame(Lcom/squareup/okhttp/internal/spdy/FrameReader$Handler;)Z
    ...
    invoke-interface {v2, v4, v5}, Lc/f;->a(J)V
    :try_end_0
    ...
    # invokes: Lcom/squareup/okhttp/internal/spdy/Http2;->readMedium(Lc/f;)I
    invoke-static {v2}, Lcom/squareup/okhttp/internal/spdy/Http2;->access$300(Lc/f;)I
...
.method public final readConnectionPreface()V
    ...
    invoke-interface {v0, v2, v3}, Lc/f;->c(J)Lc/g;
    ...
    invoke-virtual {v1, v0}, Lc/g;->equals(Ljava/lang/Object;)Z
