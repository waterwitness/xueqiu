...
.method static synthetic access$1000(Lc/f;)I
    .locals 1

    .prologue
    .line 131
    invoke-static {p0}, Lcom/squareup/okhttp/Cache;->readInt(Lc/f;)I
...
.method private static readInt(Lc/f;)I
    .locals 6

    .prologue
    .line 660
    :try_start_0
    invoke-interface {p0}, Lc/f;->k()J

    move-result-wide v0

    .line 661
    invoke-interface {p0}, Lc/f;->n()Ljava/lang/String;
...
.method final get(Lcom/squareup/okhttp/Request;)Lcom/squareup/okhttp/Response;
    ...
    invoke-virtual {v1, v3}, Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;->getSource(I)Lc/s;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/squareup/okhttp/Cache$Entry;-><init>(Lc/s;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
