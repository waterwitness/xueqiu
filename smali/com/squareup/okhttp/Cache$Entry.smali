...
.method public constructor <init>(Lc/s;)V
    ...
    .line 508
    invoke-interface {v2}, Lc/f;->n()Ljava/lang/String;
    ...
    .line 511
    # invokes: Lcom/squareup/okhttp/Cache;->readInt(Lc/f;)I
    invoke-static {v2}, Lcom/squareup/okhttp/Cache;->access$1000(Lc/f;)I
    ...
    .line 534
    invoke-direct {p0, v2}, Lcom/squareup/okhttp/Cache$Entry;->readCertificateList(Lc/f;)Ljava/util/List;
...
.method private readCertificateList(Lc/f;)Ljava/util/List;
    .locals 6
    ...
    .line 598
    # invokes: Lcom/squareup/okhttp/Cache;->readInt(Lc/f;)I
    invoke-static {p1}, Lcom/squareup/okhttp/Cache;->access$1000(Lc/f;)I
    ...
    .line 605
    invoke-interface {p1}, Lc/f;->n()Ljava/lang/String;
    ...
    invoke-direct {v5}, Lc/d;-><init>()V

    .line 607
    invoke-static {v4}, Lc/g;->b(Ljava/lang/String;)Lc/g;

    move-result-object v4

    invoke-virtual {v5, v4}, Lc/d;->a(Lc/g;)Lc/d;

    .line 608
    invoke-virtual {v5}, Lc/d;->e()Ljava/io/InputStream;
...
.method private writeCertList(Lc/e;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lc/e;->j(J)Lc/e;

    .line 620
    const/16 v0, 0xa

    invoke-interface {p1, v0}, Lc/e;->g(I)Lc/e;
    ...
    .line 623
    invoke-static {v0}, Lc/g;->a([B)Lc/g;

    move-result-object v0

    .line 1102
    iget-object v0, v0, Lc/g;->c:[B

    invoke-static {v0}, Lc/c;->a([B)Ljava/lang/String;

    move-result-object v0

    .line 624
    invoke-interface {p1, v0}, Lc/e;->b(Ljava/lang/String;)Lc/e;
...
.method public final writeTo(Lcom/squareup/okhttp/internal/DiskLruCache$Editor;)V
    ...
    .line 557
    invoke-virtual {p1, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$Editor;->newSink(I)Lc/r;
    ...
    invoke-interface {v2, v1}, Lc/e;->b(Ljava/lang/String;)Lc/e;

    .line 560
    invoke-interface {v2, v6}, Lc/e;->g(I)Lc/e;
    ...
    invoke-interface {v2, v4, v5}, Lc/e;->j(J)Lc/e;
    ...
    invoke-interface {v2, v4}, Lc/e;->b(Ljava/lang/String;)Lc/e;
    ...
    invoke-interface {v2, v0}, Lc/e;->b(Ljava/lang/String;)Lc/e;
    ...
    invoke-direct {p0, v2, v0}, Lcom/squareup/okhttp/Cache$Entry;->writeCertList(Lc/e;Ljava/util/List;)V
